...
{ 
	...
	{
	httpCompleteVoucher.open("GET", 'index.php?app=contra.voucher.new&cmd=save_vouchar&mr_no='+mr_no+'&currency='+currency+'&currencyName='+currencyName+'&created_date='+created_date+'&totaldr_amount='+totaldr_amount+'&totalcr_amount='+totalcr_amount+'&vouchar_type='+vouchar_type+'&bank_journal='+bank_journal+'&details='+details+'&adjustment='+adjustment+'&beddebts='+beddebts+'&mode_of_payment='+mode_of_payment+'&collection_source='+collection_source, true);

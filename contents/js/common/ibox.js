...
MIT Licensed Style
*********************************************************/
var indicator_img_path = "images/common/indicator.gif";
...
createIbox = function(elem) {
	...
	strHTML +=	"<div id=\"ibox_header_wrapper\"><div id=\"ibox_close\" style=\"float:right;\">";
	strHTML +=	"<a id=\"ibox_close_a\" href=\"javascript:void(null);\"><strong>Close</strong></a></div>";
	strHTML +=  "<div id=\"ibox_header\">&nbsp;</div></div>";
...
posToCenter = function(elem) {
	...
	var y = Math.round(pageSize.height/2) - (emSize.height /2) + scrollPos.scrollY+41;	// Rashed

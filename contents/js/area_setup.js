...
function processDistrictData(ResponseStr)
{
		...
		old_district 	= document.getElementById('old_district').value; 
		new_division 	= document.getElementById('division_id').value; 
		old_division 	= document.getElementById('old_division').value; 
		if(new_division==old_division){
		setSelectedOption(document.getElementById("district"),old_district);
		}
		//document.getElementById('district').value=area_id;	
}

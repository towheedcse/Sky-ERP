...
switch($currentApp)
{
   ...
   case 'physical.stock.verification': case 'voucher.edit': case 'sales.delivery.edit':  case 'subcatagory':
   case 'contra.voucher': 
   case 'contra.voucher.new': case 'avg.purchase.price':
   case 'contra.voucher.edit': case 'product.yearending':
   case 'customer.yearending': case 'supplier.yearending': case 'sales.opening': case 'sales.opening.by.trt':
   case 'product.group': case 'attach.product': case 'sales_target': case 'sales.area.update':

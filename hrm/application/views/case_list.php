            ...
            <div id="content"> <!-- Start content -->
    	                        ...
    	                        <div class="col-sm-3 col-md-3 col-lg-3">
                                    <div class="form-group required">
                                        ...
                                        <select name="status" id="status" class="chosen-select" required="">    
                                            <option value=""><?php echo $this->lang->line("select")." ".$this->lang->line("guest")." ".$this->lang->line("status");?></option>
                                            <option value="0">Pending Card</option>
                                            <option value="1">Received Card</option>
                                        </select>
                                    </div>
                                </div>
    		                </div>
				...
				<?php if($hasViewOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("guest")." ".$this->lang->line("list");?></h3>
                            <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                              <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                            </div>

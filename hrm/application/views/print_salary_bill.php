...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("print")." ".$this->lang->line("salary")." ".$this->lang->line("bill");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
               ...
               <?php echo $this->lang->line("employee")." ".$this->lang->line("salary");?>
               ...
               <?php }?>
                  ...
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active"><?php echo $this->lang->line("salary")." ".$this->lang->line("bill");?></li>
                    </ol>
                  </div><!-- /.col -->
                </div><!-- /.row -->
              </div><!-- /.container-fluid -->
				...
				<?php if($hasPrintOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("salary")." ".$this->lang->line("details");?></h3>
	...
	function loadReportForm(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>salary_bill/GetMonthlyPayBill",
			data: "bill-id="+bill_id+"&employee-id="+employee_id,
    ...
    function DownloadPDF(){
		var employee_id 	= $('#employee-id').val();
		var url ="<?php echo base_url();?>billing/downloadAdmissionPDFForm/"+admission_id;	

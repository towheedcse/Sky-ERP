        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
                ...
                <div class="row mb-2">
                  <div class="col-sm-6">
                    <h1 class="m-0 text-dark"><?php echo $this->lang->line("cash")." ".$this->lang->line("salary_sheet");?></h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
            ...
            <div id="content"> <!-- Start content -->
				...
				<?php if($hasViewOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("cash")." ".$this->lang->line("salary_sheet")." ".$this->lang->line("list");?></h3>
                            <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                              <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                            </div>
    ...
    function isNullAndUndefined(variable){
 	...
 	$('.search').click(function(){
		...
		if(company_id >0 && branch_id >0 && session_id >0 && month_name>0 && salary_month>0){
		   $.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>salary_sheet/GetCashSalarySheetRecord",

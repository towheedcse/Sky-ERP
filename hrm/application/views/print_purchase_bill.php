...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("print")." ".$this->lang->line("purchase");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
               ...
               <?php echo $this->lang->line("purchase")." ".$this->lang->line("billing");?>
               ...
               <?php }?>
                  ...
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active"><?php echo $this->lang->line("purchase")." ".$this->lang->line("billing");?></li>
                    </ol>
                  </div><!-- /.col -->
                </div><!-- /.row -->
              </div><!-- /.container-fluid -->
	...
	function loadReportForm(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>purchase/GetPurchaseBill",

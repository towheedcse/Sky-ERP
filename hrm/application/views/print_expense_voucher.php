...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("expense_voucher");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
              ...
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
				   ...
				   <?php echo $this->lang->line("expense_voucher");?>				   
					</h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      <li class="breadcrumb-item"><a href="<?php echo SERVER?>/dashboard/Userhome"><?php echo $this->lang->line("home");?></a></li>
                      <li class="breadcrumb-item active"><?php echo $this->lang->line("expense_voucher");?></li>
                    </ol>
                  </div><!-- /.col -->
                </div><!-- /.row -->

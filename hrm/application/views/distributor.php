...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("distributor")." ".$this->lang->line("setup");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
               ...
               <?php echo $this->lang->line("distributor");?>
               ...
               <?php }?>
                  ...
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active"><?php echo $this->lang->line("distributor");?></li>
                    </ol>
                  </div><!-- /.col -->
                </div><!-- /.row -->
              </div><!-- /.container-fluid -->
            ...
            <div id="content"> <!-- Start content -->
                <div class="container-fluid"> <!-- Start container-fluid --> 
					...
					<form method="post" id="InputForm" enctype="multipart/form-data" action="<?php echo base_url();?>distributor/AddRecord">
                    <div class="card card-primary show-create">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-pen-square"></i> <?php echo $this->lang->line("new");?> <?php echo $this->lang->line("distributor");?></h3>
                        ...
                        <div class="card-body">                        
							...
							<div class="card card-info card-outline">
								<div class="bg-default">
									<h3 class="container-fluid card-title"><?php echo $this->lang->line("distributor_details");?></h3>	<hr>								
								</div><!-- /.card-header -->
								<div class="container-fluid">
								    <div class="row">
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group required">
												<label class="control-label" for="distributor_name"><?php echo $this->lang->line("distributor_name");?>:</label>
												<input type="text" required="" placeholder="<?php echo $this->lang->line("distributor_name");?>" name="distributor_full_name" class="form-control" id="distributor_full_name">
											</div>
										</div>
								    ...
								    <div class="row">
										<div class="col-sm-12 col-md-12 col-lg-12">
											<div class="form-group">
												<label class="control-label" for="present_address"><?php echo $this->lang->line("distributor_address");?>:</label>
												<textarea type="text" rows="1" placeholder="<?php echo $this->lang->line("distributor_address");?>" name="present_address" class="form-control" id="present_address"></textarea>
											</div>
										</div>
									</div>
							...
							<div class="card card-info card-outline">								
								...
								<div class="container-fluid">
									<div class="row">
										...
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<label class="control-label" for="attention_person"><?php echo $this->lang->line("attention_person");?>: </label>
												<input type="text" placeholder="<?php echo $this->lang->line("attention_person");?>" name="attention_person" class="form-control" id="attention_person">
											</div>
									    </div>
										<!--div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<label class="control-label" for="permanent_address"><?php echo $this->lang->line("permanent_address");?>:</label>
												<textarea type="text" rows="1" placeholder="<?php echo $this->lang->line("permanent_address");?>" name="permanent_address" class="form-control" id="permanent_address"></textarea>
											</div>
										</div-->
							...
							<input type="hidden" name="distributor_type" id="distributor_type" value="1"> <!-- Regular -->
				...
				<?php if($hasViewOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("distributor")." ".$this->lang->line("list");?></h3>
                            <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                              <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                            </div>
    ...
    */
    ...
    var delId = $('#distributor_id').val();
    $('#distributor_id').val("");
    if(delId!=""){
        $.ajax({
        type: 'POST',
        url: "<?php echo base_url();?>distributor/DelRecord",
        data: "id="+delId,
    ...
    function reloadDataGrid(){
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url();?>distributor/GetRecord",
            success: function(option){			
    ...
    function editRecord(id){
        $.ajax({
            type: 'POST',
            url: "<?php echo base_url();?>distributor/FillRecord",
            data: "id="+id,
            success: function(option){
            //alert(option);
            rsStr = option.split("##&##");
            ...
            $('#distributor_id').val(rsStr[0]);
            $('#institute_id').val(rsStr[1]);
            $('#branch_id').val(rsStr[2]);
            $('#distributor_type').val(rsStr[3]);
            $('#distributor_full_name').val(rsStr[4]);
            $('#billing_address').val(rsStr[5]);
            $('#shipping_address').val(rsStr[6]);
            $('#contact_person').val(rsStr[7]);
            $('#designation').val(rsStr[8]); 
            $('#gender').val(rsStr[9]).trigger("chosen:updated"); 
            $('#currency').val(rsStr[10]).trigger("chosen:updated");
            $('#attention_person').val(rsStr[11]);
            ...
            $('#login_id').val(rsStr[21]);
            $('#password').val(rsStr[22]); $('#confirm_password').val(rsStr[22]); 
    ...
    $(document).ready(function(){
        ...
        $('#institute_id').val("1");
        $('#branch_id').val("1");
        $('#distributor_type').val("1");
        
		//$('#institute_id').val(1).trigger("chosen:updated");
	    $('#currency').val("Bangladeshi").trigger("chosen:updated");
    ...
    function getDistrictList(division_id,placement,district_id=0){
          $.ajax({
            type: 'POST',
            url: "<?php echo base_url();?>distributor/GetAjaxDistrictList",
    ...
    function getAreaList(district_id,placement,area_id=0){
          $.ajax({
            type: 'POST',
            url: "<?php echo base_url();?>distributor/GetAjaxAreaList",

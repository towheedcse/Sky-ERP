...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("print")." ".$this->lang->line("delivery_challan");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
    ...
    <!-- Content Wrapper. Contains page content -->
        <div class="content-wrapper">
               ...
               <?php }?>
                  ...
                  <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                      ...
                      <li class="breadcrumb-item active"><?php echo $this->lang->line("delivery_challan");?></li>
                    </ol>
                  </div><!-- /.col -->
                </div><!-- /.row -->
              </div><!-- /.container-fluid -->
            ...
            <div id="content"> <!-- Start content -->
                ...
                <input type="hidden" name="challan-id" id="challan-id" value="<?php echo $challan_id;?>">
				<input type="hidden" name="workorder-id" id="workorder-id" value="<?php echo $workorder_id;?>">           
				<?php if($hasPrintOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("delivery_challan")." ".$this->lang->line("details");?></h3>
    ...
    $(document).ready(function(){
		...
		var challan_id=<?php echo $challan_id;?>;
		//Load dataGrid
		loadReportForm();
    });
	...
	function loadReportForm(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>deliverychallan/GetChallanDetails",
			data: "challan-id="+challan_id+"&workorder-id="+workorder_id,

                        ...
                        <div class="card-body">                        
							...
							<div class="card card-info card-outline">
								<div class="bg-default">
									<h3 class="container-fluid card-title"><?php echo $this->lang->line("customer_details");?></h3>	<hr>								
								</div><!-- /.card-header -->
								<div class="container-fluid">
								    <div class="row">
										...
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group required">
												<label class="control-label" for="customer_name"><?php echo $this->lang->line("customer_name");?>:</label>
												<input type="text" required="" placeholder="<?php echo $this->lang->line("customer_name");?>" name="customer_full_name" class="form-control" id="customer_full_name">
											</div>
										</div>
								    ...
								    <div class="row">
									    <div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												<label class="control-label" for="customer_address"><?php echo $this->lang->line("customer_address");?>:</label>
												<textarea type="text" rows="1" placeholder="<?php echo $this->lang->line("customer_address");?>" name="present_address" class="form-control" id="present_address"></textarea>
											</div>
										</div>
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
									...
									<div class="row">
										...
										<div class="col-sm-3 col-md-3 col-lg-3">
											<div class="form-group required">
												...
												<select name="nationality" id="nationality" class="chosen-select" required="">
													<option value=""><?php echo $this->lang->line("select")." ".$this->lang->line("nationality");?></option>        
										...
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												...
												<select name="salesman_id" id="salesman_id" class="chosen-select">
										...
										<!--div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												...
												<textarea type="text" rows="1" placeholder="<?php echo $this->lang->line("present_address");?>" name="present_address" class="form-control" id="present_address"></textarea>
											</div>
										</div>
										<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
										...
										<div class="col-sm-3 col-md-3 col-lg-3">
										    ...
										    <input type="hidden" name="billing_address" class="form-control" id="billing_address" value="">
							...
							<input type="hidden" name="customer_type" id="customer_type" value="1"> <!-- Regular -->
    ...
    */
    ...
    function editRecord(id){
        $.ajax({
            ...
            $('#customer_type').val(rsStr[3]);
            $('#customer_full_name').val(rsStr[4]);
            ...
            $('#nationality').val(rsStr[10]).trigger("chosen:updated");
            $('#salesman_id').val(rsStr[11]).trigger("chosen:updated");

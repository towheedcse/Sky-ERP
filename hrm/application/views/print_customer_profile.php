...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("customer")." ".$this->lang->line("profile");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
               ...
               <?php echo $this->lang->line("customer")." ".$this->lang->line("profile");?>
	...
	function loadReportForm(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>customer/GetProfile",
    ...
    function DownloadPDF(){
		var customer_id 	= $('#customer-id').val();
		var url ="<?php echo base_url();?>customer/downloadEmpPDFForm/"+customer_id;	

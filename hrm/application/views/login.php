...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::Log In</title>
    
    <link rel="canonical" href="http://www.jaftourism.deasbd.com/" />
    <meta name="description" content="Billing management system in Bangladesh." />
    
    <meta name="keywords" content="jaftourism, deasbd, billing management system" />
    <meta name="author" content="www.jaftourism.deasbd.com" />
...
<div class="wrapper">
    <div class="container">
        ...
        <?php echo form_open('dashboard/LoginProcess')?>
        <form method="post" id="form">
            ...
            <div class="input-inform">
                <input type="text" name="user_name" id="user_name" style="background-color: #000;padding: 8px 0 8px 9px;" required placeholder="LOGIN ID" />
                <input type="password" name="password" id="password" style="background-color: #000;padding: 8px 0 8px 9px;" required placeholder="PASSWORD" />
                <input type="hidden" value="FORGOT PASSWORD?" id="forgot-password"/>
            </div>
            <div class="enter">
...
<script>
    ...
    function valid(form) {
        var fail = false,
            user = form.user_name.value.trim(),

...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("print")." ".$this->lang->line("importer_po");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
               ...
               <?php echo $this->lang->line("importer_po");?>
				...
				<?php if($hasPrintOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("importer_po")." ".$this->lang->line("details");?></h3>
	...
	function loadReportForm(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>distributorpo/GetIPODetails",
			data: "po-id="+po_id+"&importer-id="+importer_id,

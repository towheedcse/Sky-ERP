...
<body class="hold-transition sidebar-mini">
              ...
              <div class="container-fluid">
                <div class="row mb-2">
                  <div class="col-sm-6">
                    ...
                    <?php echo $this->lang->line("received")." ".$this->lang->line("card")." ".$this->lang->line("guest");?>
                    </h1>
                  </div><!-- /.col -->
                  <div class="col-sm-6">
            ...
            <div id="content"> <!-- Start content -->
				...
				<?php if($hasViewOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-list"></i> <?php echo $this->lang->line("received")." ".$this->lang->line("card")." ".$this->lang->line("guest")." ".$this->lang->line("list");?></h3>
                            <div class="card-tools">
                              <button type="button" class="btn btn-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                              <button type="button" class="btn btn-tool" data-widget="remove"><i class="fa fa-remove"></i></button>
                            </div>
    ...
    function reloadDataGrid(){
 	...
 	$('.search').click(function(){
		...
		var status          = 1;
		if(isNullAndUndefined(status)){ status=1;}

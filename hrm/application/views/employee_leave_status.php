...
<head>
    ...
    <title><?php echo $this->session->userdata('short_name');?>::<?php echo $this->lang->line("employee")." ".$this->lang->line("leave");?> </title>
    <style type="text/css">
        .btn-file {
            position: relative;
            overflow: hidden;
...
<body class="hold-transition sidebar-mini">
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
              <div class="container-fluid">
               ...
               <?php echo $this->lang->line("employee")." ".$this->lang->line("leave")." ".$this->lang->line("status");?>
				...
				<?php if($hasPrintOption){?>
                    <div class="card box-primary">
                        <div class="card-header">
                            <h3 class="card-title"><i class="fa fa-file"></i> <?php echo $this->lang->line("leave");?></h3>
	...
	function loadReportForm(){
		...
		$.ajax({
			type: 'POST',
			url: "<?php echo base_url();?>employee/GetEmpLeave",

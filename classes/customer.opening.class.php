...
class CustomerOpening
{
  ...
  function showEditor()
  {
	...
	$cusql= "SELECT * FROM vw_customer_details WHERE project_id = '$project_id' AND `sub_id` REGEXP ('A001337') ORDER BY `sub_id` ASC";
	...
	*/
	...
	$cusql= "SELECT * FROM vw_customer_details WHERE project_id = '$project_id' AND `sub_id` REGEXP ('A000882|A001175|A001048|A000925') ";
	$cres = mysql_query($cusql);
	$sl=1;
	while($arow=mysql_fetch_object($cres)){
	//======= Start March to May Sales Opening ==========
	$customer = $arow->sub_id; $sales_amount = $arow->may16_sales;
	$paid_amount = $arow->may16_receipt; $return_amount = $arow->may16_return; $baddebt_amount = $arow->may16_baddebt;
   ...
   function saveInSalesTbl($customer,$op_amount,$op_type,$sales_amount,$paid_amount,$return_amount,$baddebt_amount,$sales_date){
	...
	VALUES('$voucher_no','A000014','$project_id','OP','Opening Balance','$vouchar_type','Opening Recievable','$due','Recievable amount of Jan-1 to Feb 28 2014','Active','$created_by','$created_date')";
	...
	created_date,status) VALUES('$voucher_no','$customer','$project_id','Customer','Opening Balance','$vouchar_type','Opening Recievable','$debit','0','$due','Recievable amount of Jan-1 to Feb 28 2014','Active','$created_by','$created_date','0')";
	...
	VALUES('$voucher_no','$customer','Customer','$project_id','Others','$vouchar_type','Opening Payble','$credit','Payble amount of Jan-1 to Feb 28 2014','Active','$created_by','$created_date')";
	...
	created_date,status) VALUES('$voucher_no','A000028','$project_id','Accounts Payable','Others','$vouchar_type','Opening Payble','$debit','0','$debit','Payble amount of Jan-1 to Feb 28 2014','Active','$created_by','$created_date','0')";
   ...
   function saveMarchOpening($project_id,$customer,$sales_amount,$paid_amount,$return_amount,$baddebt_amount,$sales_date){
	   ...
	   if($sales_amount>0){ // === Dr ====	Opening Sales is OS, A002286 = Sates Item	    
		...
		$salesApp->saveAccountJournal($voucher_no,$customer,"Customer",$project_id,"Opening Sales Delivery 16 May to 31 May 2014",$sales_amount,0,$PartyBalance,1,$sales_date);
		if($rest_of_amount>0){
		$vouchar_type ='Recievable Vouchar'; $status = 0; $debit = $rest_of_amount; $description = "Opening Sales Delivery of 16 May to 31 May 2014";
		$sqlDV="INSERT INTO ".CREDIT_VOUCHAR_TBL."(voucher_no,account_head,project_id,head_type,transaction_type,vouchar_type,transaction_name,credit,description,list_view,created_by,created_date) 
		...
		$PartyBalance  = ($totalPartyDR-($totalPartyCR+$paid_amount));	
		$voucher_no 	= $PurApp->createVoucharID();					 
		$salesApp->saveAccountJournal($voucher_no,$customer,"Customer",$project_id,"Opening Receipt Amount of 16 May to 31 May 2014",0,$paid_amount,$PartyBalance,1,$sales_date);	
		$vouchar_type ='Received Vouchar'; $debit = $paid_amount; $description = "Receipt Amount ($paid_amount Tk) of 16 May to 31 May 2014";
		$sqlDV="INSERT INTO ".CREDIT_VOUCHAR_TBL."(voucher_no,account_head,project_id,head_type,transaction_type,vouchar_type,transaction_name,credit,description,list_view,created_by,created_date) 
		...
		$PartyBalance  = ($totalPartyDR-($totalPartyCR+$return_amount));
		$voucher_no 	= $PurApp->createVoucharID();						 
		$salesApp->saveAccountJournal($voucher_no,$customer,"Customer",$project_id,"Opening Sales Return of 16 May to 31 May 2014",0,$return_amount,$PartyBalance,1,$sales_date);
		$vouchar_type ='Received Vouchar'; $debit = $return_amount; $description = "Opening Sales Return of 16 May to 31 May 2014";
		$sqlDV="INSERT INTO ".CREDIT_VOUCHAR_TBL."(voucher_no,account_head,project_id,head_type,transaction_type,vouchar_type,transaction_name,credit,description,list_view,created_by,created_date) 
		...
		$BDBalance     = ($totalPartyDR-($totalPartyCR+$baddebt_amount));
		$voucher_no 	= $PurApp->createVoucharID();						 
		$salesApp->saveAccountJournal($voucher_no,$customer,"Customer",$project_id,"Opening Sales Baddebt of 16 May to 31 May 2014",0,$baddebt_amount,$BDBalance,1,$sales_date);
		$vouchar_type ='Received Vouchar'; $debit = $baddebt_amount; $description = "Opening Sales Baddebt of 16 May to 31 May 2014";
		$sqlDV="INSERT INTO ".CREDIT_VOUCHAR_TBL."(voucher_no,account_head,project_id,head_type,transaction_type,vouchar_type,transaction_name,credit,description,list_view,created_by,created_date) 

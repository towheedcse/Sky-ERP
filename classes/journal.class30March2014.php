    ...
    function savePaymentCreditVouchar($voucher_no)
 	{     
		  ...
		  if($res['affected_rows']) {
			...
			if(getRequest('srref_no')!="" && getRequest('dir')=="SalesReturn"){
				$srref_no = getRequest('srref_no'); $return_id = getRequest('return_id');
				require_once(CLASS_DIR.'/sales.return.class.php');	
				$srApp = new SalesReturn();
				$srApp->updategetSalesReturnPayble($return_id,$srref_no,$voucher_no,$CrAmount);
			}			

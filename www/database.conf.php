<?php
    ...
    *  Purpose: this file is used to store database table name constants and it also starts the database connection
    *  CVS ID: $Id$
    ********************************************************/
  ...
  */
   ...
   if (PRODUCTION_MODE)
   {
     ...
     define('NDB_NAME', 'liraerp2017'); // Next will be liraerp2017
   }
...
//========  Table For SSGROUP  ===================
   ...
   define('CS_DELIVERY_PRODUCT_TBL',        DB_NAME . '.delivery_product');  //4 himagur 		 	        
   define('ACC_TRANSACTION_TBL',            DB_NAME . '.delivery_product');  //4 himagur but not used
   ...
   define('PURCHASE_RECEIVED_TBL',   		DB_NAME . '.purchase_received'); //new -190211              		 		 	        
   ...
   define('SALES_TARGET_TBL',			DB_NAME . '.sales_target');  // new             		 		 	        
   ...
   define('AVG_PURCHASE_PRICE_TBL',   		DB_NAME . '.avg_purchase_price'); // New 
   
   define('TMP_GRVMASTER_TBL',   		DB_NAME . '.tmp_grv_master');    

   define('MACHINE_TBL',   			DB_NAME . '.machine');			// new 2017
   define('VEHICLES_TBL', 			DB_NAME . '.vehicles');            	// new 2026        		 		 	        
   ...
   //define('CUSTOMER_SALES_LEDGER_VIEW',   		DB_NAME . '.vw_customer_sales_ledger');
   ...
   define('DELIVERY_PRODUCT_LEDGER_VIEW',  		DB_NAME . '.vw_delivery_product_ledger'); // new
   
   define('DELIVERY_SALES_STATUS_VIEW',  		DB_NAME . '.vw_delivery_sales_status'); // new

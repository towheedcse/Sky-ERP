...
<html lang="en">
  ...
  <body>
    <div class="navbar bg-base-100 shadow-sm">
      <div class="navbar-start">
        <div class="dropdown">
          ...
          >
            <li><a href="/">Home</a></li>
            <li><a href="./cost report.html">Cost Report</a></li>
            <li><a href="./LC report.html">LC Report</a></li>
            <li><a href="./unapprove order.html">Unapproved Orders</a></li>
          </ul>
        </div>
      </div>
    ...
    <div class="px-4 py-2 md:px-12 md:py-4">
      <h1 class="text-3xl font-bold mb-3">LC Report</h1>
      <form
      ...
      >
        ...
        <label class="form-control flex-1 relative">
          <div class="label">
            <span class="label-text font-bold">Voucher No</span>
          </div>
          <input
            type="text"
      ...
      <div class="py-3 md:py-8 px-2 md:px-5 mt-3 rounded-lg shadow-lg ml-2">
        ...
        >
          <h2 class="text-xl font-bold mb-3">Voucher List</h2>
          <div class="join">
            <button
        ...
        <div class="text-center font-medium">
          <div class="text-lg">Some Company Ltd.</div>
          <div>address, some address, bangladesh</div>
        </div>
...
$sql = "SELECT * 
        ...
        WHERE account_journal.description = 'Zobayer'";
...
<tr>
                ...
                <td>
                  <div>Petty cash</div>
                  <div>Some Company LTD.</div>
                </td>
                <td>
                  Cash Adjustment
                  <div class="text-xs">Created By "someone"</div>
                </td>
                <td>
                  <div>3994</div>
                  <div>0</div>

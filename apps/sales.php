<?php
   ...
   //Including header
	if(getRequest('cmd') != 'loadProduct' && getRequest('cmd') != 'loadSOInfo' && getRequest('cmd')!="get_uprice" && getRequest('cmd')!="get_serial")
	{
	require_once(HEADER);
	}
   ...
   //Including footer
	if(getRequest('cmd') != 'loadProduct' && getRequest('cmd')!="get_uprice" && getRequest('cmd')!="get_serial")
	{
	//require_once(FOOTER);
	}
